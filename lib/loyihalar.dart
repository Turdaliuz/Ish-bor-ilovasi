...
class loyihalar extends StatefulWidget {
  const loyihalar({Key? key}) : super(key: key);

  @override
  State<loyihalar> createState() => _loyihalarState();
}

class _loyihalarState extends State<loyihalar> {
  @override
            ...
            child: Column(
              children: [
                Container(
                    ...
                    child: Text("Bo'limlardan birini tanlab loyiha izlang:", style: TextStyle(letterSpacing: 1, color: Colors.teal, fontWeight: FontWeight.w500, fontSize: 14),)),
